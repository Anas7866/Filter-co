    ...
    return (
        <>
            <div className='col-md-12 background_footer padding_top_bottom_left_right_products py-5 '>
                <div className='row'>
                    ...
                    <div className='col-md-3 alignment2  px-md-5 px-4 py-0 pt-2'>
                        ...
                        <a className='text_dec_stop ' > <p className='m-0 p-0 pt-1 '><FaWhatsapp className='icon_green_t' /> &nbsp;(+966) 599189997</p> </a>
                    ...
                    <div className='col-md-3 alignment2  px-md-5 px-4 py-0 pt-2'>
                        ...
                        <a className='text_dec_stop ' > <p className='m-0 p-0 pt-1 '><FaWhatsapp className='icon_green_t' /> &nbsp;(+966) 599445710</p> </a>
                        {/* <a className='text_dec_stop ' href="tel:+966532776424"> <p className='m-0 p-0 pt-1 '><FaPhoneAlt className='icon_green_t' /> &nbsp;+966 53 277 6424</p> </a> */}
                        <a className='text_dec_stop' href="mailto:Filtercity@outlook.sa">   <p className='m-0 p-0 pt-2 '><IoMail className='icon_green_t' /> &nbsp;Filtercity@outlook.sa</p> </a>
                        <a className='text_dec_stop' target="_blank" href="https://www.google.com/maps/place/%D8%B4%D8%B1%D9%83%D8%A9+%D9%85%D8%AF%D9%8A%D9%86%D8%A9+%D8%A7%D9%84%D9%81%D9%84%D8%A7%D8%AA%D8%B1+%D9%84%D9%84%D8%AA%D8%AC%D8%A7%D8%B1%D8%A9%E2%80%AD/@21.4495865,39.1934368,13z/data=!4m6!3m5!1s0x15c3cf227be4e993:0xc407748ff46fb4b7!8m2!3d21.4229958!4d39.2565208!16s%2Fg%2F11c5wmg98h?authuser=0&entry=ttu&g_ep=EgoyMDI1MDIyNi4xIKXMDSoASAFQAw%3D%3D">   <p className='m-0 p-0 pt-2 '><FaLocationDot className='icon_green_t' /> &nbsp;
            ...
            <div className='col-md-12 background_ff'>
                <p className='m-0 p-0 py-1'>Copyright 2025 &copy; FILTER CITY TRADING CO.</p>
            </div>
        </>
    )
}
